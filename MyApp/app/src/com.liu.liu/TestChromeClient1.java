...
/**
 * Created by yulong.liu on 2016/4/5 0005.
 */
public  class TestChromeClient1 extends WebChromeClient {

    private WebChromeClient mWrappedClient;

    protected TestChromeClient1(WebChromeClient wrappedClient) {
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile) {
        ((TestChromeClient1) mWrappedClient).openFileChooser(uploadFile);
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile, String acceptType) {
        ((TestChromeClient1) mWrappedClient).openFileChooser(uploadFile, acceptType);
    }
